  ...
  return (
    <>
      ...
      <div className="flex items-center gap-1 mb-6 bg-stone-100 rounded-xl p-1 w-fit">
        ...
        >
          Actifs
          <span className={`ml-2 text-xs ${tab === 'active' ? 'text-terracotta' : 'text-stone-400'}`}>
        ...
        >
          Anciens
          <span className={`ml-2 text-xs ${tab === 'former' ? 'text-terracotta' : 'text-stone-400'}`}>
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-stone-50">
                  ...
                  <th className="px-6 py-3 text-left text-xs font-medium text-stone-500 uppercase tracking-wider">Bien associé</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-stone-500 uppercase tracking-wider">Loyer</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-stone-500 uppercase tracking-wider">Paiement</th>
                  <th className="px-6 py-3 text-left text-xs font-medium text-stone-500 uppercase tracking-wider">Entrée</th>
                  <th className="px-6 py-3 text-right text-xs font-medium text-stone-500 uppercase tracking-wider">Actions</th>
                </tr>
              </thead>
              <tbody>
                {filtered.map((tenant) => (
                  <tr key={tenant.id} className="border-b border-stone-100 hover:bg-stone-50/50 transition-colors">
                    {/* Avatar + Nom */}
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-end gap-1">
                        <Link
                          ...
                          className="p-2 rounded-lg text-stone-400 hover:text-terracotta hover:bg-terracotta/5 transition-colors"
                          title="Voir"
                        >
                        ...
                        <button
                          ...
                          className="p-2 rounded-lg text-stone-400 hover:text-slate-900 hover:bg-stone-100 transition-colors"
                          title="Modifier"
                        >
