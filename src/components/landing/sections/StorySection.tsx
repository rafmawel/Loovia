...
export function StorySection() {
  ...
  return (
    <section ref={ref} className="landing-section bg-bg-section relative overflow-hidden">
      ...
      {/* Étoiles décoratives */}
      <Star4 className="absolute top-20 right-20 w-5 h-5 animate-twinkle hidden lg:block" color="#E8622A" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        <div className={`max-w-3xl ${inView ? 'animate-fade-up' : 'opacity-0'}`}>
          ...
          <h2 className="font-display text-[clamp(32px,4.5vw,56px)] font-bold leading-[1.05] tracking-[-0.025em] mb-10">
            Créé par un propriétaire.{' '}
            <span className="text-accent">Pour les propriétaires.</span>
          </h2>
          ...
          <div className="space-y-6 text-text-secondary text-base leading-[1.85]">
            ...
            <p>
              ...
              <span className="text-accent font-medium">Bonne question.</span>
            </p>
            <p>
